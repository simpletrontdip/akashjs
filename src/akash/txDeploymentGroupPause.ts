...
import { MsgPauseGroup } from "../codec/akash/deployment/v1beta2/groupmsg";
...
export class TxDeploymentGroupPause {
  ...
  public async params(
    params: TxDeploymentGroupPauseParams
  ): Promise<BroadcastTxResponse> {
    const owner = this.akash.address;

    const { memo = "", fee = defaultFee, dseq, gseq } = params;
    ...
    return this.akash.signingClient.deploymentGroupPause(
      owner,
      request,
      fee,
      memo
