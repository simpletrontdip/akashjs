...
const query_1 = require("../codec/akash/audit/v1beta2/query");
const query_2 = require("../codec/akash/cert/v1beta2/query");
const query_3 = require("../codec/akash/deployment/v1beta2/query");
const query_4 = require("../codec/akash/market/v1beta2/query");
const query_5 = require("../codec/akash/provider/v1beta2/query");
...
class Akash {
    ...
    static connect(endpoint, signer) {
        return __awaiter(this, void 0, void 0, function* () {
            const tmClient = yield tendermint_rpc_1.Tendermint34Client.connect(endpoint);
            const signingClient = yield signingAkashClient_1.SigningAkashClient.connectWithSigner(endpoint, signer);
