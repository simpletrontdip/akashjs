...
function createPEMBlocks(address, naf = 365, // certificate is not valid after this many days.
...
signAlgorithm = "ECDSA", hashAlgorithm = "SHA-256") {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const keyPair = (yield crypto.generateKey(algo.algorithm, true, algo.usages));
        ...
        //endregion
        yield certificate.subjectPublicKeyInfo.importKey(keyPair.publicKey);
        yield certificate.sign(keyPair.privateKey, hashAlgorithm);
        return {
            owner: address,
            serialNumber: serialNumber,
            certificate: certificate.toSchema(true).toBER(false),
            privateKey: yield crypto.exportKey("pkcs8", keyPair.privateKey),
            publicKey: yield crypto.exportKey("spki", keyPair.publicKey),
        };
    });
}
exports.createPEMBlocks = createPEMBlocks;
function savePEMBlocks(pemBlocks) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, idb_keyval_1.set)(pemBlocks.owner, pemBlocks);
    });
}
exports.savePEMBlocks = savePEMBlocks;
function loadPEMBlocks(owner) {
    return __awaiter(this, void 0, void 0, function* () {
        const pemBlocks = yield (0, idb_keyval_1.get)(owner);
        if (!pemBlocks) {
...
function deletePEMBlocks(owner, serial) {
    return __awaiter(this, void 0, void 0, function* () {
        const pemBlocks = yield loadPEMBlocks(owner);
